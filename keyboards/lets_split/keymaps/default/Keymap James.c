 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |ISO ~ | ISO| | ISO ~|      |      |      |  0   |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_SLSH, KC_7,  KC_8,  KC_9, _______, _______, \
  _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,   KC_F6,  KC_4  ,  KC_5 ,  KC_6 ,_______ ,_______, \
